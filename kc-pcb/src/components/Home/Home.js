...
const Home = ()=>{
    ...
    return (
        <div className={classes.container}>
            <video className={classes.bgHome} src={`${process.env.PUBLIC_URL}/videos/video-1.mp4`} autoPlay loop muted />
            ...
            <img className={classes.img} src={`${process.env.PUBLIC_URL}/WhatsApp Image 2022-05-22 at 14.05.38.jpeg`} />
