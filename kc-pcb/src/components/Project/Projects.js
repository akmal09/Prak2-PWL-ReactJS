...
function Projects(){
    return(
        <div className="projects">
                <video className="bgProject" src={`${process.env.PUBLIC_URL}/videos/video-1.mp4`} autoPlay loop muted />
                <ul className="project">
                    <Project
                        src={`${process.env.PUBLIC_URL}/GitHub-Mark/PNG/GitHub-Mark-64px.png`}
